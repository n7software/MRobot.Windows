...
namespace MRobot.Windows.Utilities
{
    ...
    public class PopupMenuTemplateSelector : DataTemplateSelector
    {
        public DataTemplate LinksTemplate { get; set; }
        ...
        public override DataTemplate SelectTemplate(object item, DependencyObject container)
        {
            ...
            if (menuItem != null)
            {
                return menuItem.CustomContentTemplate ?? LinksTemplate;
            }
